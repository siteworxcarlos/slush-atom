    ...
    inquirer.prompt(prompts,
        function(answers) {
            ...
            gulp.src(__dirname + '/templates/*.mustache')
                ...
                .pipe(conflict('./'))
                .pipe(gulp.dest( __dirname + '/source/_patterns/00-atoms/00-'+answers.appName))
                .pipe(install())
                .on('end', function() {
                    done();
                });
            ...
            gulp.src(__dirname + '/templates/*.scss')
                ...
                .pipe(conflict('./'))
                .pipe(gulp.dest( __dirname + '/source/css/scss/modules/'+answers.appName))
                .pipe(install())
                .on('end', function() {
                    done();
                });
            ...
            gulp.src('/source/css/*.scss')
                ...
                .pipe(gulp.dest( __dirname + '/source/css/'))
                .pipe(install())
                .on('end', function() {
                    done();
                });
